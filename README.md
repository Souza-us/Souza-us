...
### Estudante de Ciência da Computação | Cyber Security | Redes de Computadores | Software Engineer
...
Minha trajetória profissional é marcada pela versatilidade e pela transição estratégica para a área de tecnologia. Atuei anteriormente no setor corporativo como operador em relacionamento ao cliente, instrutor de treinamento e, mais recentemente, como supervisor de operações. Essas vivências me deram uma visão sistêmica apurada, facilidade para lidar com pressão e foco em resultados. 

Hoje, direciono essa maturidade corporativa e minha paixão por tecnologia para a programação, unindo minha bagagem analítica à minha formação técnica para construir soluções eficientes e seguras.
